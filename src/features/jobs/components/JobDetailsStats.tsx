        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-white text-text-main flex flex-col gap-6 rounded-xl border border-btn-sec-border">
                ...
                <div className="px-6 pb-6">
                    <div className="text-2xl font-bold text-text-main">{applicants}</div>
                </div>
            </div>
            ...
            <div className="bg-white text-text-main flex flex-col gap-6 rounded-xl border border-btn-sec-border">
                ...
                <div className="px-6 pb-6">
                    <div className="text-2xl font-bold text-green-500">{interviewed}</div>
                </div>
            </div>
            ...
            <div className="bg-white text-text-main flex flex-col gap-6 rounded-xl border border-btn-sec-border">
                ...
                <div className="px-6 pb-6">
                    <div className="text-2xl font-bold text-text-main">{daysActive}</div>
                </div>
            </div>
        </div>
    );
