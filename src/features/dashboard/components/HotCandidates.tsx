...
import { HotCandidate } from "../types";

interface HotCandidatesProps {
    candidates?: HotCandidate[];
}

export const HotCandidates: React.FC<HotCandidatesProps> = ({ candidates = [] }) => {
  return (
