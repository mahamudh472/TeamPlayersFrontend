...
export const CandidatesList: React.FC = () => {
    ...
    const getFilteredCandidates = () => {
        switch (activeTab) {
            ...
            case "interview":
                return searchedCandidates.filter((c) => c.status === "interview");
            case "high-fit":
                return searchedCandidates.filter((c) => c.matchScore >= 85);
            default:
    ...
    const tabOptions: TabOption[] = [
        ...
        { label: `Interview (${searchedCandidates.filter((c) => c.status === "interview").length})`, value: "interview" },
        { label: `High Fit (${searchedCandidates.filter((c) => c.matchScore >= 85).length})`, value: "high-fit" },
    ];
                ...
                <div className="space-y-3">
                    {filteredList.map((candidate) => (
                        ...
                        >
                            ...
                            <div className={`absolute left-0 top-0 bottom-0 w-1 ${candidate.indicatorColor}`} />
